...
My tool does treat some matrices angles read from the DAE correctly.
If that happends, you can just tell the tool to reuse an already existing and correct MDLX skeleton.
